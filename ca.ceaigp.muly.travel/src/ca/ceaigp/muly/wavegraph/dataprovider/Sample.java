 ...
 ******************************************************************************/
package ca.ceaigp.muly.wavegraph.dataprovider;
...
public class Sample implements ISample
{
	 ...
	 * @param info
	 */
	public Sample(final double xValue, final double yValue, final double yPlusError, final double yMinusError, final double xPlusError,
	        final double xMinusError, final String info)
	{
		this.xValue = xValue;
		this.yValue = yValue;
	...
	// return (((Sample)obj).xValue == xValue && ((Sample)obj).yValue ==
	// yValue);
	// return false;
	// }
	...
	public boolean equals(Object obj)
	{
		...
		if (Double.doubleToLongBits(xMinusError) != Double.doubleToLongBits(other.xMinusError)) return false;
		if (Double.doubleToLongBits(xPlusError) != Double.doubleToLongBits(other.xPlusError)) return false;
		if (Double.doubleToLongBits(xValue) != Double.doubleToLongBits(other.xValue)) return false;
		if (Double.doubleToLongBits(yMinusError) != Double.doubleToLongBits(other.yMinusError)) return false;
		if (Double.doubleToLongBits(yPlusError) != Double.doubleToLongBits(other.yPlusError)) return false;
		if (Double.doubleToLongBits(yValue) != Double.doubleToLongBits(other.yValue)) return false;
		return true;
	}
	...
	public String toString()
	{
		...
		buf.append("(");
		buf.append(xValue);
		if (xMinusError != 0 || xPlusError != 0) buf.append(" [-" + xMinusError + " ... +" + xPlusError + "]");
		buf.append(", ");
		buf.append(yValue);
		if (yMinusError != 0 || yPlusError != 0) buf.append(" [-" + yMinusError + " ... +" + yPlusError + "]");
		if (info != null && info.length() > 0) buf.append(", '" + info + "'");
		buf.append(")");
		return buf.toString();
	}
}
