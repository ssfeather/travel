...
import ca.ceaigp.muly.wavegraph.dataprovider.IDataProvider;
import ca.ceaigp.muly.wavegraph.linearscale.LinearScale;
import ca.ceaigp.muly.wavegraph.linearscale.Range;
import ca.ceaigp.muly.wavegraph.undo.AxisPanOrZoomCommand;
import ca.ceaigp.muly.wavegraph.undo.SaveStateCommand;
import ca.ceaigp.muly.wavegraph.undo.ZoomType;
import ca.ceaigp.muly.wavegraph.util.GraphicsUtil;
import ca.ceaigp.muly.wavegraph.util.Log10;
import ca.ceaigp.muly.wavegraph.util.SWTConstants;
import ca.ceaigp.muly.wavegraph.util.XYGraphMediaFactory;
import ca.ceaigp.muly.wavegraph.util.XYGraphMediaFactory.CURSOR_TYPE;
