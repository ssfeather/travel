 ...
 ******************************************************************************/
package ca.ceaigp.muly.wavegraph.toolbar;
...
import ca.ceaigp.muly.wavegraph.figures.XYGraphFlags;
import ca.ceaigp.muly.wavegraph.undo.AddAnnotationCommand;
import ca.ceaigp.muly.wavegraph.undo.IOperationsManagerListener;
import ca.ceaigp.muly.wavegraph.undo.OperationsManager;
import ca.ceaigp.muly.wavegraph.undo.RemoveAnnotationCommand;
import ca.ceaigp.muly.wavegraph.undo.ZoomType;
import ca.ceaigp.muly.wavegraph.util.SingleSourceHelper;
